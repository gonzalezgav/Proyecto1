...
from Proyecto1.views import saludo, segunda_vista, diaDeHoy,miNombreEs,probandoTemplate, tercera_vista  #Para acceder a la vista hay que importar el modulo y el método
